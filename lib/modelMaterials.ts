...
/**
 * What a mesh looked like when it arrived.
 *
 * This used to be parked on `mesh.userData`, which is a trap: `Object3D.copy`
 ...
 *
 * It lives here instead, keyed weakly by the mesh, where nothing serialises it
...
/** Left behind by a version that drew a wire cage over the transparent view. */
